...
function BikiniBeachTable() {
  ...
  // this updates the date of each table by adding one day
  ...
  // the update function gets all of the table information and passes it to the modal form where the user adds their comments and images
        ...
        <div className="p-3">
          ...
          <div className="overflow-x-auto">
            <table className="table-auto w-full">
              ...
              {/* Table body */}
              {/* the colours in the table change as per the wave size and winddirection */}
...
export default BikiniBeachTable;
